...
export const DELETE = withApiObservability(async (_req, { params }: { params: { id: string } }) => {
  ...
  await db.query(`DELETE FROM watchlist WHERE id = ? AND userId = ? LIMIT 1`, [params.id, userId]);
